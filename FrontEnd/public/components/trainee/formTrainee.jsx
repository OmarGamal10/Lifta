    ...
    <div className="flex flex-row min-h-screen justify-center items-center bg-textColor p-16">
      <div className="container border-2 border-solid bg-backGroundColor border-primary flex flex-col items-center justify-center p-8 max-w-2xl rounded-3xl relative">
        ...
        >
          ...
          <div className="bg-backGroundColor w-1/2 mb-10 flex flex-col">
            <h6 className="text-xs text-left text-textColor mb-2">
              Workout Preferences
            </h6>
            ...
            <button
              ...
              className="text-textColor  hover:bg-secondary focus:ring-2 focus:outline-none focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
              type="button"
            >
              {formData.workoutPreferences === "outdoors"
                ? "Outdoors"
                : "Indoors"}
              <svg
              ...
              >
                <ul className="py-2  text-sm text-primary">
                  <li>
                    <button
                      type="button"
                      onClick={() => handleWorkoutPreferencesSelect("outdoors")}
                  ...
                  <li>
                    <button
                      type="button"
                      onClick={() => handleWorkoutPreferencesSelect("indoors")}
                      className="block w-full text-left px-4 py-2 hover:bg-secondary  hover:text-backGroundColor"
                    >
                      Indoors
                    </button>
