...
<div className="flex items-center space-x-[25px] p-10 bg-transparent rounded-lg ml-4 md:ml-6 lg:ml-14 w-full">
    ...
    <div>
        <p className="text-[31px] md:text-[28px] lg:text-[31px] font-bold text-textColor">Anas Magdy</p>
        <span className="text-[25px] md:text-[25px] pl-6 lg:text-[25px] font-bold text-textspan">I'm a software engineer</span>
    </div>
</div>
